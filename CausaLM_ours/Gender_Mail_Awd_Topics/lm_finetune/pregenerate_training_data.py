...
import json
import collections
from constants import BERT_PRETRAINED_MODEL, GENDER_TOPICS_PRETRAIN_DATA_DIR, MAX_GENDER_SEQ_LENGTH, \
    GENDER_TOPICS_DATASETS_DIR, GENDER_TOPICS_DOMAIN_TREAT_CONTROL_MAP_FILE, GENDER_DOMAINS
...
def main():
    ...
    parser.add_argument("--max_seq_len", type=int, default=MAX_GENDER_SEQ_LENGTH)
    ...
    parser.add_argument("--domain", type=str, default="mail_awd", choices=GENDER_DOMAINS)
...
def generate_data_for_domain(args, domain):
    ...
    with DocumentDatabase(reduce_memory=args.reduce_memory) as docs:
        ...
        output_dir = Path(GENDER_TOPICS_PRETRAIN_DATA_DIR) / domain
        output_dir.mkdir(exist_ok=True, parents=True)
        unique_ids, reviews, treatment_labels, control_labels = list(), list(), list(), list()
        for dataset in ("train", "dev"):
            DATASET_FILE = f"{GENDER_TOPICS_DATASETS_DIR}/topics_{dataset}.csv"
