...
GENDER_TOPICS_DATASETS_DIR = f"/home/mlepekhin/CausaLM/Gender_Mail_Awd_Topics/datasets"
GENDER_TOPICS_MODELS_DIR = f"/home/mlepekhin/CausaLM/Models/Gender_Mail_Awd/Topics" 
GENDER_TOPICS_PRETRAIN_DIR = f"{GENDER_TOPICS_MODELS_DIR}/Pretrain"
GENDER_TOPICS_PRETRAIN_DATA_DIR = f"{GENDER_TOPICS_PRETRAIN_DIR}/data"
GENDER_TOPICS_PRETRAIN_MLM_DIR = f"{GENDER_TOPICS_PRETRAIN_DIR}/MLM"
GENDER_TOPICS_PRETRAIN_IXT_DIR = f"{GENDER_TOPICS_PRETRAIN_DIR}/IXT"

GENDER_DOMAINS = ("mail_awd")
GENDER_TOPICS_DOMAIN_TREAT_CONTROL_MAP_FILE = f"{GENDER_TOPICS_DATASETS_DIR}/domain_treat_control_topics.json"
...
POMS_GENDER_MODEL_DIR = f"{POMS_MODELS_DIR}/Gender_Mail_Awd"
